#  oneHot encoding- breast Cancer dataset:
import pandas as pd
...
# print(data.head())
column_names = ["age", "menopause", "tumor_size", "inv_nodes", "node_caps",
                "deg_malig", "breast", "breast_quad", "irradiat", "class"]  # Define meaningful column names

data = pd.read_csv('/home/ibab/breast_cancer_row.csv', names=column_names)
