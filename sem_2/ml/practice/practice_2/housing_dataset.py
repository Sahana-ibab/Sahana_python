...
target_col = 'median_house_value'  # Change this if target column is different
...
df.to_csv("/mnt/data/housing_preprocessed.csv", index=False)
print("\nPreprocessed dataset saved as 'housing_preprocessed.csv'.")
